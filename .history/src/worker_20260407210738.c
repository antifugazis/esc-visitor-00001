...
void WorkerInit(WorkerRig *worker, const char *modelPath, const char *animDir)
{
    ...
    LoadClip(worker, WORKER_ANIM_START_WALK, TextFormat("%s/Start Walking.fbx", animDir));
    LoadClip(worker, WORKER_ANIM_WALK, TextFormat("%s/Walking.fbx", animDir));
    LoadClip(worker, WORKER_ANIM_TURN, TextFormat("%s/Turning.fbx", animDir));
    LoadClip(worker, WORKER_ANIM_TURN_RIGHT, TextFormat("%s/Right Turn.fbx", animDir));
    LoadClip(worker, WORKER_ANIM_TURN_LEFT, TextFormat("%s/Left Turn.fbx", animDir));
    LoadClip(worker, WORKER_ANIM_RUN, TextFormat("%s/Running.fbx", animDir));
